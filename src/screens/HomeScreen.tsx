  ...
  return (
    <View className="justify-center flex-1 px-6 bg-zinc-950">
      ...
      <Text className="mt-3 text-lg leading-6 text-zinc-400">
        Feeling hungry but out of ideas? Tap the button below and discover a random delicious meal.
      </Text>

      <View className="mt-10">
        <PrimaryButton title="Generate Random Meal" onPress={handleGenerateMeal} />
      </View>
    </View>
  );
}
